...
<div class="main">
    <div class="container">
        ...
        <button id="deletegenerated" style="margin-bottom: 5px;" class="btn btn-info" onclick='DeleteAutoGeneratedListings()'><id style="margin-left: 0; margin-right: 4px;" class="fa fa-times"></i>Delete Autogenerated Listings</button>
    </div>
</div>
