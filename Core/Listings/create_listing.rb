...
begin
    ...
    result = create_listing(username, data["rent"], data["address"], data["bedrooms"], data["bathrooms"], data["animals"], data["laundry"], dadata["parking"], data["ac"], data["type"], data["start_date"], data["latitude"], data["longitude"], data["tags"])
