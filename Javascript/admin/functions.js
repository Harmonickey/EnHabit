...
function UpdateListing(oid)
{
    ...
    var data = BuildData(inputs, ["User", "Landlord", "Address", "Unit", "Rent", "Start", "University", "Bedrooms", "Bathrooms", "Tags", "Notes", "Animals", "Laundry", "Parking", "AirConditioning", "Type", "Latitude", "Longitude", "SelectedAddress"]);
...
function CreateListing()
{
    ...
    var data = BuildData(inputs, ["Address", "Unit", "Rent", "Start", "University", "Bedrooms", "Bathrooms", "Animals", "Laundry", "Parking", "AirConditioning", "Type", "Notes", "Landlord", "User", "Tags", "Latitude", "Longitude", "SelectedAddress"]);
