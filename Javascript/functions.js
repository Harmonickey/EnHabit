        ...
        "<div class='item-content listing'>" +
            ...
            "<div class='information'>" +
                ...
                "<div class='col-lg-2 col-md-2 col-sm-2'>" +
                    "<input type='button' class='btn btn-outline-inverse btn-sm' value='More Details' onclick=\"OpenListing('" + data._id.$oid + "', '" + data.Address + "', '" + data.Unit + "', '" + data.Bedrooms + "', '" + data.Bathrooms + "', '" + data.Price + "', '" + data.Type + "', '" + data.Notes + "', '" + data.HasAnimals + "', '" + data.HasLaundry + "', '" + data.HasParking + "', '" + data.HasAirConditioning + "', [" + data.Tags + "], [" + data.Thumbnails + "], '" + data.WorldCoordinates.x + "', '" + data.WorldCoordinates.y + "')\" />" +
                "</div>" +
            "</div>" +
        "</div>");
...
function OpenListing(Id, Address, Unit, Bedrooms, Bathrooms, Price, Type, Notes, Animals, Laundry, Parking, AirConditioning, Tags, Images, x, y, listingInfo)
{
    $("#details-view").fadeIn();
